    ...
    <div className="wrapper">
      ...
      <div className="cultural">
        ...
        <div className="cultural-info-section" >
          ...
          <div className="cultural-text">Giving students a platform, to show their culture</div>
        </div>
        <div className="cultural-info-section" >
        <div className="icon-container">
          <img src={Favorite} alt="Graduation Cap" />
          </div>
          <div className="cultural-text">Teaching the new generations about vietnamese customs</div>
        </div>
        <div className="cultural-info-section" >
        <div className="icon-container">
